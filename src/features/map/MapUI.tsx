  ...
  return (
    <div className="h-full">
      ...
      <div className="fixed bottom-24 right-2 z-800">
        <FabButton backgroundColor="bg-green-200" onClick={() => dispatch(uiActions.showFilter())}>
          <AdjustmentsIcon className="icon-size" />
        </FabButton>
      </div>

      <MapOverlay isShowing={ui.isFilterShowing} onCloseMapOverlay={() => dispatch(uiActions.hideFilter())}>
      ...
      <MapOverlay isShowing={ui.isTeaserShowing} onCloseMapOverlay={() => dispatch(uiActions.hideTeaser())}>
