...
const allSportsIconImage: IconImage = {
  ...
  sportTypes: [SPORT_TYPE.BASKETBALL, SPORT_TYPE.FITNESS, SPORT_TYPE.SOCCER, SPORT_TYPE.TABLE_TENNIS],
};
...
const basketballFitnessIconImage: IconImage = {
  ...
  sportTypes: [SPORT_TYPE.BASKETBALL, SPORT_TYPE.FITNESS],
};

const basketballSoccerIconImage: IconImage = {
  imageUrl: basketballSoccerMarkerImage,
  sportTypes: [SPORT_TYPE.BASKETBALL, SPORT_TYPE.SOCCER],
};
...
const fitnessSoccerIconImage: IconImage = {
  ...
  sportTypes: [SPORT_TYPE.FITNESS, SPORT_TYPE.SOCCER],
};
const fitnessSoccerBasketballIconImage: IconImage = {
  imageUrl: fitnessSoccerBasketballMarkerImage,
  sportTypes: [SPORT_TYPE.BASKETBALL, SPORT_TYPE.FITNESS, SPORT_TYPE.SOCCER],
};
...
const tableTennisBasketballIconImage: IconImage = {
  ...
  sportTypes: [SPORT_TYPE.BASKETBALL, SPORT_TYPE.TABLE_TENNIS],
};
...
const tableTennisSoccerIconImage: IconImage = {
  ...
  sportTypes: [SPORT_TYPE.SOCCER, SPORT_TYPE.TABLE_TENNIS],
};

const tableTennisSoccerBasketballIconImage: IconImage = {
  imageUrl: tableTennisSoccerBasketballSMarkerImage,
  sportTypes: [SPORT_TYPE.BASKETBALL, SPORT_TYPE.SOCCER, SPORT_TYPE.TABLE_TENNIS],
};
